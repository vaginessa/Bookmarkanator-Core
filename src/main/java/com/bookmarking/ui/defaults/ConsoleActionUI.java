...
public class ConsoleActionUI implements ActionUIInterface
{
    private static final Logger logger = LogManager.getLogger(ConsoleActionUI.class.getCanonicalName());
